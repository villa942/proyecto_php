    ...
    <section id="contact" class="contact" >
      <div class="container" >
        ...
        <div class="section-title " >
          <h2 >Contactenos</h2>
          <p>Tus opiniones, felicitaciones, sugerencias o inquietudes son importantes para nosotros, por eso colocamos a tu disposición los siguientes canales</p>
        </div>
      </div>
      <div class="container">
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Ubicacion:</h4>
                <p>Red Vallecaucana de Salud</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Correo:</h4>
                <p>redvallecaucana@salud.com</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="../Plantilla/Controladores/controlador.contactenos.php" method="post" >
              <div class="form-row">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="Asunto"  placeholder="Asunto" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
